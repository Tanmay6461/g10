...
import Model.services.CanteenService;
...
public class Booking {
    ...
    public Booking(Canteen canteen, Network network) {
        this.services = new ArrayList<>();
        this.services.add(new CanteenService(canteen));
    ...
    public CanteenService getHotelService() {
        for (Service service : services) {
            if (service instanceof CanteenService) {
                return (CanteenService) service;
            }
        }
